<template>
    <aside class="aside__top">
        <span
            class="iconfont icon-caidan toggleNavCollapse"
        ...
        <el-breadcrumb separator="/">
            <transition-group name="breadcrumb">
                ...
                <el-breadcrumb-item
                    v-for="(route,i) in crumbList" :key="route.name" :to="{name:route.name}" v-if="route.name!='home'" :class="{'is-last-link':i==crumbList.length-1}"
                >
                    {{route.meta.name}}
                </el-breadcrumb-item>
            </transition-group>
        ...
        <div class="aside__top--right">
            <!-- <div class="email">
                <a href="#/user-center/message">
                    <span class="iconfont icon-tongzhi"><i>12</i></span>
                </a>
            </div> -->
            <div class="user-msg">
                <!-- <img class="user-img" :src="require('@/assets/image/a.png')" alt=""> -->
                
                <el-dropdown placement="top" @command="userAbout">
